...
// IsJoinControlNo reports whether the rune has unicode property "Join_Control"="No".
...
// IsJoinControlYes reports whether the rune has unicode property "Join_Control"="Yes".
// Property "Join_Control" known as "Join_C", "Join_Control".
