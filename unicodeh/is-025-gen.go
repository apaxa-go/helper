...
// IsASCIIHexDigitNo reports whether the rune has unicode property "ASCII_Hex_Digit"="No".
...
// IsASCIIHexDigitYes reports whether the rune has unicode property "ASCII_Hex_Digit"="Yes".
// Property "ASCII_Hex_Digit" known as "AHex", "ASCII_Hex_Digit".
