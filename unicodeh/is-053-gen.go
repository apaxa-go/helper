...
// IsIDSTrinaryOperatorNo reports whether the rune has unicode property "IDS_Trinary_Operator"="No".
...
// IsIDSTrinaryOperatorYes reports whether the rune has unicode property "IDS_Trinary_Operator"="Yes".
// Property "IDS_Trinary_Operator" known as "IDST", "IDS_Trinary_Operator".
