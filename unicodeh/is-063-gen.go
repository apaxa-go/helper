...
// IsOtherIDStartNo reports whether the rune has unicode property "Other_ID_Start"="No".
...
// IsOtherIDStartYes reports whether the rune has unicode property "Other_ID_Start"="Yes".
// Property "Other_ID_Start" known as "OIDS", "Other_ID_Start".
