...
// IsIDSBinaryOperatorNo reports whether the rune has unicode property "IDS_Binary_Operator"="No".
...
// IsIDSBinaryOperatorYes reports whether the rune has unicode property "IDS_Binary_Operator"="Yes".
// Property "IDS_Binary_Operator" known as "IDSB", "IDS_Binary_Operator".
