...
// IsVariationSelectorNo reports whether the rune has unicode property "Variation_Selector"="No".
...
// IsVariationSelectorYes reports whether the rune has unicode property "Variation_Selector"="Yes".
// Property "Variation_Selector" known as "VS", "Variation_Selector".
